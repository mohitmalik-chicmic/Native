          ...
          this.downlaodZip = () => {
            ...
            if (result) {
              ...
              assetManager.loadRemote(path, {
                ...
                console.log("Printing ImageAssest", path, imageAsset); // this.RandomSprite.spriteFrame = imageAsset;
              });
            }
          };
        }
...
//# sourceMappingURL=614866a2a57eb3060f76ae574e3a1e486a655553.js.map