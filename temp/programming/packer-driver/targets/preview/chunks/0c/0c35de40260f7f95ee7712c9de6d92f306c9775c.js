    ...
    execute: function () {
      ...
      _export("Zip", Zip = (_dec = ccclass("Zip"), _dec2 = property(Sprite), _dec(_class = (_class2 = class Zip extends Component {
        constructor() {
          ...
          this.downlaodZip = () => {
            console.log("clikced");
            var result = native.reflection.callStaticMethod("com/cocos/game/AppActivity", "ZipDownload", "(I)I", 1);
            console.log("COCOS resuklt", result);
            if (result > 0) this.showImages();
          };

          this.showImages = () => {
            var result = native.reflection.callStaticMethod("com/cocos/game/AppActivity", "getImages", "(Ljava/lang/String;)Ljava/lang/String;", "start");
...
//# sourceMappingURL=0c35de40260f7f95ee7712c9de6d92f306c9775c.js.map