    ...
    execute: function () {
      ...
      _export("Zip", Zip = (_dec = ccclass("Zip"), _dec2 = property(Sprite), _dec(_class = (_class2 = class Zip extends Component {
        constructor() {
          ...
          this.downlaodZip = () => {
            console.log("clikced");
            var result = native.reflection.callStaticMethod("com/cocos/game/AppActivity", "ZipDownlaod", "(I)V");
...
//# sourceMappingURL=1775d1a7cbd993211d7006a31c07b92b0e267086.js.map