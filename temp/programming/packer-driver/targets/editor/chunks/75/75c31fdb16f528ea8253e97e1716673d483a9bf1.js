System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ImageAsset, SpriteFrame, Texture2D, Sprite, native, assetManager, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Zip;
        ...
        constructor(...args) {
          ...
          this.downlaodZip = () => {
            ...
            if (result) {
              ...
              let path = `${result}/Mask/maskLeft.png`;
              assetManager.loadRemote(result, function (err, imageAsset) {
                if (err) {
                  console.log("NOT FOUND");
                  return;
                }

                console.log("Printing ImageAssest", imageAsset);
              });
            }
          };
        }
...
//# sourceMappingURL=75c31fdb16f528ea8253e97e1716673d483a9bf1.js.map