          ...
          this.downlaodZip = () => {
            ...
            if (result) {
              ...
              assetManager.loadRemote(absolutePath, (err, imageAsset) => {
                ...
                console.log("SPRITE", JSON.stringify(spriteFrame)); //this.RandomSprite.spriteFrame = spriteFrame;    
                //this.node.getComponent(Sprite).spriteFrame = spriteFrame;
              });
              let absolutePath2 = `${result}/Mask`;
              assetManager.loadRemote(absolutePath2, (err, bundle) => {
                if (err) {
...
//# sourceMappingURL=f0a1d56cf3ba13188b488f3070517ef55f361566.js.map