          ...
          this.downlaodZip = () => {
            ...
            if (result) {
              ...
              assetManager.loadRemote(path, {
                ...
                console.log("Printing ImageAssest", path, JSON.stringify(imageAsset)); //   this.RandomSprite.spriteFrame = spriteFrame;
              });
            }
          };
        }
...
//# sourceMappingURL=ab23830d4943daeef2851ddf26c304483ee44e00.js.map