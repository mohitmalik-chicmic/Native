          ...
          this.downlaodZip = () => {
            ...
            if (result) {
              ...
              assetManager.loadRemote(path, {
                ...
                console.log("Printing ImageAssest", path, JSON.stringify(spriteFrame)); //this.RandomSprite.spriteFrame = imageAsset;
              });
            }
          };
        }
...
//# sourceMappingURL=ac8e183ef01c2d5fdd7cb48508cc00014a3d04b4.js.map