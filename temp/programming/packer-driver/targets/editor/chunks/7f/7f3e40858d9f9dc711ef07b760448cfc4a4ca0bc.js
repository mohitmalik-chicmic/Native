    ...
    execute: function () {
      ...
      _export("Zip", Zip = (_dec = ccclass("Zip"), _dec2 = property(Sprite), _dec(_class = (_class2 = class Zip extends Component {
        constructor(...args) {
          ...
          this.downlaodZip = () => {
            console.log("clikced");
            let result = native.reflection.callStaticMethod("com/cocos/game/AppActivity", "ZipDownload", "(I)I", 1);
...
//# sourceMappingURL=7f3e40858d9f9dc711ef07b760448cfc4a4ca0bc.js.map