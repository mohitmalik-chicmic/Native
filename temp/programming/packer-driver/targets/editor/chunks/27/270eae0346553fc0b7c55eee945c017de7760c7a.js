System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ImageAsset, SpriteFrame, Texture2D, Sprite, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Zip;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Zip", Zip = (_dec = ccclass("Zip"), _dec2 = property(Sprite), _dec(_class = (_class2 = class Zip extends Component {
        ...
        start() {
          console.log("CHECK 1");
          this.createDemoImage(); //  var zip = new JSZip();
          // console.log("CHECK 2 Printing Zip",zip);
          // //Picture
...
//# sourceMappingURL=270eae0346553fc0b7c55eee945c017de7760c7a.js.map