          ...
          this.downlaodZip = () => {
            ...
            if (result) {
              ...
              assetManager.loadRemote(path, {
                ...
                console.log("Printing ImageAssest", path, JSON.stringify(spriteFrame)); //   this.RandomSprite.spriteFrame = spriteFrame;
              });
            }
          };
        }
...
//# sourceMappingURL=ecdf5cf491347f2c888486a060e2cc6042b89297.js.map